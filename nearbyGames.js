  ...
  data: [
    {
      game_name: "Monopoly",
      general_details:
        "experienced players preferred, college students preferred, parking available, food provided",
    ...
    },
    {
      game_name: "Scrabble",
      general_details:
        "BYOB, no food provided, 21 years old and up, parking unavailable",
    ...
    },
    {
      ...
      general_details:
        "BBQ before party, BYOB, parking available, pets present, adults only, no previous experience necessary",
    ...
    },
    {
      ...
      general_details:
        "Private event, Staff and RSVP only, food provided, no alcohol, guest and staff parking, all age groups, any level of experience",
    ...
    },
    {
      game_name: "Charades",
      general_details:
        "Staff and family members only, food provided, wine provided, guest parking",
    ...
    },
    {
      game_name: "Yahtzee",
      general_details:
        "No food or drinks, water ok, all age groups, previous experience preferred",
    ...
    },
    {
      game_name: "Clue",
      general_details:
        "No alcohol, all age groups, parking available, pets in the house, no previous experience required",
    ...
    },
    {
      game_name: "Ouija",
      general_details:
        "Will have alcohol, BYOB, no food, pets in the house, no parking available",
    ...
    },
    {
      game_name: "Monopoly",
      general_details:
        "BBQ before the game, all age groups, BYOB, parking available, carpool available, no previous experience required",
    ...
    },
    {
      ...
      general_details:
        "some alcohol provided, BYOB, no food provided, no parking, carpool available, 21 years and older only",
    ...
    },
    {
      game_name: "Sorry!",
      general_details:
        "Kids game, BBQ for parents, parking available, no experience required",
    ...
    },
    {
      ...
      general_details:
        "two dogs in the house, all age groups, food provided, no parking",
    ...
    },
    {
      game_name: "Catan",
      general_details:
        "no alcohol, bring your own food, parking available, no previous game exprience necessary, all age groups",
...
function populateMap(response) {
  for (var i = 0; i < response.data.length; i++) {
    var latLng = new google.maps.LatLng(
      parseFloat(response.data[i].lat),
      parseFloat(response.data[i].lon)
    );
    ...
    var gameName = response.data[i].game_name;
    marker.content =
      `<h4 style="color:black;">${response.data[i].game_name}</h4>` +
      `<p style="color:black;"><strong>Date: </strong>${response.data[i]
        .date}</p>` +
      `<p style="color:black;"><strong>Time: </strong>${response.data[i]
        .time}</p>`;
    marker.place = {
